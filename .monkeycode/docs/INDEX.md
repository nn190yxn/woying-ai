...
我赢AI是面向本地生活经营者的经营工作平台，第一阶段聚焦儿童素质培训机构，核心链路围绕“经营体检 -> 本周行动 -> 执行记录 -> 七天复盘 -> 陪跑服务”组织。校长侧优先使用校区、课程、家长、体验课、到店、报名和续费等业务语言；家长跟进按新咨询到报名及暂未报名的顺序推进，少儿体育续费与消课使用出勤、训练表现、教练反馈和剩余课时语言；会员及陪跑服务明确系统整理提醒与真人顾问确认纠偏边界。当前代码库包含 Vue 3 前端、Express 后端、知识库、微信小程序目录和项目规范文档。
...
- 线上环境核查记录（2026-08-21）：`.monkeycode/docs/线上环境核查记录-2026-08-21.md`
- 竞品与产品战略评估（2026-08-21）：`.monkeycode/docs/竞品与产品战略评估-2026-08-21.md`
- 第一阶段产品聚焦决策：`.monkeycode/docs/产品聚焦决策-儿童素质培训-2026-08-21.md`
...
- 2026-08-21 只读核查确认线上 Nginx 将 `/api` 转发至 `127.0.0.1:3000`；本机后端默认端口 `3001` 仅代表当前源码默认值，不代表线上实际环境变量。
...
- 2026-08-28�����ߣ�Monkeycode������Ӫ��������7��ɡ���̨��ְ����飻����������������־�ɷ����Ȩ�ޱ�������־������������������Ϣ���֣�Ȩ�����������ع�ͨ����ר��4/4����������3/3��ǰ�˹���770 modulesͨ����ȫվɨ��ʣ��79������������8��������β������δ����δǨ�ơ�δ�ύ������8δ������
- ʵʩ�嵥��`.monkeycode/specs/sitewide-operations-copy/tasklist.md`
