...
const categoryMeta = {
  finance: { name: '先把账算明白', description: '先算清招生投入、课程收入、成本和场地使用，再决定下一步。' },
  operations: { name: '让团队照标准做', description: '把接待、跟进、上课和续费流程整理成团队能执行的标准。' },
  marketing: { name: '把家长带进来', description: '围绕招生活动、老带新和家长跟进安排持续动作。' },
  content: { name: '让家长看懂课程', description: '围绕家长问题准备短视频、笔记、课程卖点和沟通内容。' },
  diagnosis: { name: '找出主要问题', description: '从招生、体验、报名和续费数据中找出本周最该处理的环节。' },
  ip: { name: '让校长和教练被信任', description: '围绕校长、教练和课程特色积累家长信任。' },
  planning: { name: '安排经营动作', description: '把招生、活动、课程和团队动作排成可执行的安排。' }
}
...
export const allTools = [
  createTool({ code: 'headline', name: '爆款标题助手', description: '快速生成抖音、朋友圈、小红书等高点击标题。', tag: '内容', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'content', industries: ['restaurant', 'education', 'beauty', 'service', 'douyin'], freePolicy: '3/day', sceneTags: ['标题', '内容获客'] }),
  ...
  createTool({ code: 'close-deal', name: '成交话术助手', description: '针对客户犹豫点生成更容易成交的话术。', tag: '成交', iconColor: 'green', requiredLevel: MEMBER_LEVEL_FREE, category: 'content', industries: ['education', 'beauty', 'service'], freePolicy: '3/day', sceneTags: ['成交转化', '咨询话术'] }),
  createTool({ code: 'friend', name: '朋友圈文案助手', description: '适合日常发圈、活动预热和复购提醒。', tag: '营销', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_FREE, category: 'marketing', industries: ['restaurant', 'education', 'beauty', 'service'], freePolicy: '3/day', sceneTags: ['发圈', '活动预热', '复购提醒'] }),
  createTool({ code: 'roi', name: '投流 ROI 工具', description: '算清投流后的投入产出，避免继续盲投。', tag: '计算', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant', 'education', 'beauty', 'service', 'douyin'], freePolicy: '3/day', sceneTags: ['ROI', '投流判断'] }),
  createTool({ code: 'payback', name: '回本周期工具', description: '结合客单价和毛利率快速估算回本周期。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant', 'education', 'beauty', 'service'], freePolicy: '3/day', sceneTags: ['回本', '投资判断'] }),
  ...
  createTool({ code: 'hook', name: '钩子文案助手', description: '把短视频开头、海报标题和开场句做得更抓人。', tag: '内容', iconColor: 'pink', requiredLevel: MEMBER_LEVEL_FREE, category: 'content', industries: ['restaurant', 'education', 'beauty', 'douyin'], freePolicy: '3/day', sceneTags: ['钩子', '短视频开头'] }),
  createTool({ code: 'script', name: '短视频脚本助手', description: '给出结构完整的脚本框架，适合老板和员工直接开拍。', tag: '内容', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_FREE, category: 'content', industries: ['restaurant', 'education', 'beauty', 'service', 'douyin'], freePolicy: '2/day', sceneTags: ['脚本', '短视频'] }),
  createTool({ code: 'xiaohongshu', name: '小红书内容助手', description: '面向种草场景输出标题、正文和互动引导。', tag: '内容', iconColor: 'pink', requiredLevel: MEMBER_LEVEL_FREE, category: 'content', industries: ['beauty', 'education', 'service'], freePolicy: '2/day', sceneTags: ['种草', '小红书'] }),
  ...
  createTool({ code: 'sop', name: 'SOP 助手', description: '适合前台接待、服务流程、交付流程标准化。', tag: '制度', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_STARTER, category: 'operations', industries: ['restaurant', 'education', 'beauty', 'service'], capabilityType: 'industry', sceneTags: ['SOP', '流程管理'] }),
  createTool({ code: 'marketing-plan', name: '营销方案助手', description: '根据目标、预算和周期自动生成完整营销执行方案。', tag: '策划', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_STARTER, category: 'planning', industries: ['restaurant', 'education', 'beauty', 'service'], sceneTags: ['营销方案', '活动策划'] }),
  ...
  createTool({ code: 'topic', name: '选题助手', description: '持续补充老板账号、门店账号的内容选题池。', tag: '内容', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_STARTER, category: 'marketing', industries: ['education', 'beauty', 'douyin'], capabilityType: 'industry', sceneTags: ['选题', '内容规划'] }),
  ...
  createTool({ code: 'employee-incentive', name: '员工激励方案助手', description: '为不同岗位生成包含薪酬结构、KPI和激励措施的完整方案。', tag: '管理', iconColor: 'green', requiredLevel: MEMBER_LEVEL_STARTER, category: 'operations', industries: ['restaurant', 'education', 'beauty', 'service'], sceneTags: ['员工激励', '绩效管理'] }),
  ...
  createTool({ code: 'price-increase', name: '涨价方案助手', description: '科学涨价策略，包含客户沟通、风险防范和效果评估。', tag: '管理', iconColor: 'orange', requiredLevel: MEMBER_LEVEL_PRO, category: 'operations', industries: ['restaurant', 'education', 'beauty', 'service'], sceneTags: ['定价', '涨价'] }),
  createTool({ code: 'promotion-plan', name: '降价促销方案助手', description: '设计促销目标、宣传计划和风险防范方案。', tag: '营销', iconColor: 'pink', requiredLevel: MEMBER_LEVEL_STARTER, category: 'marketing', industries: ['restaurant', 'education', 'beauty', 'service'], sceneTags: ['促销', '打折'] }),
  ...
  createTool({ code: 'competitor-strategy', name: '竞争应对策略助手', description: '分析竞品并制定差异化竞争策略，避免价格战。', tag: '分析', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_PRO, category: 'planning', industries: ['restaurant', 'education', 'beauty', 'service'], sceneTags: ['竞品应对', '差异化'] }),
  ...
  createTool({ code: 'competitor', name: '竞品分析', description: '拆竞争对手的卖点、打法和差异化位置。', tag: '分析', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_PRO, category: 'diagnosis', industries: ['restaurant', 'education', 'beauty', 'service'], capabilityType: 'industry', sceneTags: ['竞品', '增长判断'] }),
  createTool({ code: 'business-plan', name: '商业计划书助手', description: '适合梳理项目定位、经营模型和阶段目标。', tag: '方案', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_PRO, category: 'planning', industries: ['restaurant', 'education', 'beauty', 'service'], capabilityType: 'industry', sceneTags: ['经营方案', '项目规划'] }),
  ...
  createTool({ code: 'ip-agent', name: 'IP 打造工具', description: '围绕老板定位、账号人设和直播表达给出完整建议。', tag: 'IP', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_ANNUAL, category: 'ip', industries: ['education', 'beauty', 'service', 'douyin'], capabilityType: 'advanced', sceneTags: ['老板IP', '人设定位', '直播表达'] }),
  createTool({ code: 'gross-margin-restaurant', name: '品类毛利工具（餐饮版）', description: '多品类毛利率对比分析，快速定位高毛利/低毛利品类，优化菜单结构。', tag: '计算', iconColor: 'orange', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['毛利率', '品类分析', '利润结构'] }),
  createTool({ code: 'break-even-restaurant', name: '盈亏平衡点工具（餐饮版）', description: '拆分固定/变动成本，算出保本营业额、客流、翻台率、坪效线，附带 What-If 场景对比和行业基准诊断。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['盈亏平衡', '保本营业额'] }),
  createTool({ code: 'turnover-rate-restaurant', name: '翻台率工具（餐饮版）', description: '快速计算翻台率，判断餐桌利用率是否达标。', tag: '计算', iconColor: 'green', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['翻台率', '餐桌利用率'] }),
  createTool({ code: 'renewal-rate-education', name: '续费率工具（教培版）', description: '快速计算续费率，判断教学质量与学员留存健康度。', tag: '计算', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['续费率', '学员留存'] }),
  createTool({ code: 'class-consumption-rate-education', name: '课时消耗率工具（教培版）', description: '快速计算课时消耗进度，判断预收款消化速度。', tag: '计算', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['课时消耗', '预收款'] }),
  createTool({ code: 'card-consumption-rate-beauty', name: '耗卡率工具（美业版）', description: '快速计算耗卡率，判断预收卡项的消耗进度。', tag: '计算', iconColor: 'pink', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['耗卡率', '预收卡项'] }),
  createTool({ code: 'salary-cost-ratio-restaurant', name: '人工成本占比工具（餐饮版）', description: '基于岗位明细拆分前/后/管人工成本，综合评估人效与成本结构，自动输出优化建议。', tag: '计算', iconColor: 'orange', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['人效', '成本控制', '排班优化'] }),
  createTool({ code: 'dish-pricing', name: '菜品定价工具（结构设计版）', description: '基于三层产品组合矩阵（引流菜/主推菜/形象菜），科学设计菜单定价结构，自动推荐套餐组合，预测门店综合毛利。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['定价', '产品结构', '菜单设计', '套餐组合'] }),
  createTool({ code: 'food-waste-rate', name: '食材损耗率工具', description: '帮你算后厨到底浪费了多少钱。', tag: '计算', iconColor: 'green', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['损耗', '成本控制'] }),
  createTool({ code: 'food-yield-rate', name: '食材出成率工具', description: '帮你算食材从毛料到净料的出成比例和真实成本。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['出成率', '净料率', '食材成本'] }),
  createTool({ code: 'delivery-profit', name: '外卖利润工具', description: '帮你算清外卖到底是在赚钱还是在给平台打工。', tag: '计算', iconColor: 'orange', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['外卖', '利润'] }),
  createTool({ code: 'delivery-analysis', name: '外卖经营综合分析', description: '从单件利润到月度经营、保本线、堂食对比，全方位分析外卖健康度。', tag: '分析', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['外卖', '经营分析', '平台抽成'] }),
  createTool({ code: 'inventory-turnover', name: '库存周转率工具（餐饮版）', description: '帮你算食材库存周转是否健康，避免积压浪费资金。', tag: '计算', iconColor: 'green', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['库存', '周转率', '资金效率'] }),
  createTool({ code: 'dish-contribution', name: '菜品贡献度分析（BCG 四象限）', description: '把每道菜放到四象限里看，明星/现金流/潜力/淘汰一目了然。', tag: '分析', iconColor: 'orange', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['菜品分析', '四象限', '菜单优化'] }),
  createTool({ code: 'repurchase-rate', name: '复购率/回头客工具（餐饮版）', description: '帮你算有多少顾客愿意回头再来，附带 LTV 客户价值估算。', tag: '计算', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['复购率', '回头客', 'LTV'] }),
  createTool({ code: 'cup-efficiency', name: '出杯效率工具（奶茶版）', description: '奶茶/小吃店专用，算平均出杯效率、高峰压力、峰谷比，替代翻台率。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['出杯效率', '奶茶', '高峰分析'] }),
  createTool({ code: 'drink-cost', name: '饮品配方成本工具（奶茶版）', description: '拆解每杯奶茶的原料成本，自动计算毛利率和定价建议。', tag: '计算', iconColor: 'pink', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['配方成本', '奶茶', '定价'] }),
  createTool({ code: 'payback-restaurant', name: '投资回本周期工具（餐饮版）', description: '帮你算新店/新项目多久能回本。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['回本', '投资'] }),
  createTool({ code: 'cashflow-restaurant', name: '现金流预测工具（餐饮版）', description: '按固定/变动成本拆分，预测未来逐月现金流，标记断裂风险和安全线。', tag: '计算', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['现金流', '预测', '资金断裂'] }),
  createTool({ code: 'profit-rate-restaurant', name: '利润率工具（餐饮版）', description: '帮你算出门店真正赚了多少。', tag: '计算', iconColor: 'green', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['利润率', '成本结构'] }),
  createTool({ code: 'return-rate-restaurant', name: '回报率工具（餐饮版）', description: '帮你判断营销活动/投流到底值不值。', tag: '计算', iconColor: 'pink', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['ROI', '营销'] }),
  createTool({ code: 'investment-budget', name: '开店投资预算工具', description: '拆分装修/设备/租金/流动资金，自动生成投资占比和保本推演。', tag: '计算', iconColor: 'orange', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['开店', '投资预算', '资金规划'] }),
  createTool({ code: 'gross-margin-education', name: '毛利率工具（教培版）', description: '帮你算清每门课的真实利润，哪些课看着热闹其实在亏钱。', tag: '计算', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['毛利率', '课程利润'] }),
  createTool({ code: 'break-even-education', name: '盈亏平衡点工具（教培版）', description: '帮你算出每月至少招多少学员/排多少课才不亏。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['盈亏平衡', '保本营收'] }),
  createTool({ code: 'salary-cost-ratio-education', name: '员工成本占比工具（教培版）', description: '帮你判断教练工资是不是吃掉了太多营收。', tag: '计算', iconColor: 'orange', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['人效', '成本控制'] }),
  createTool({ code: 'labor-efficiency-education', name: '教练人效', description: '按教练负责的课程收入、课时和人工成本，判断排课与人员投入是否合理。', tag: '计算', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['人效', '排课'] }),
  createTool({ code: 'venue-utilization-education', name: '场地利用率', description: '按可排课时段与实际开课时段计算场地使用情况，找出空置和排课拥挤时段。', tag: '计算', iconColor: 'green', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['场地利用', '排课优化'] }),
  createTool({ code: 'cac-education', name: '新生招生成本（CAC）', description: '获客成本（CAC）是招到一名新报名学员平均花费的招生费用，帮你比较不同渠道。', tag: '计算', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['获客成本', '渠道'] }),
  createTool({ code: 'payback-education', name: '投资回本周期工具（教培版）', description: '帮你算新校区/新项目多久能回本。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['回本', '投资'] }),
  createTool({ code: 'cashflow-education', name: '现金流预测工具（教培版）', description: '帮你提前预判资金链断裂风险。', tag: '计算', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['现金流', '预测'] }),
  createTool({ code: 'profit-rate-education', name: '利润率工具（教培版）', description: '帮你算出门店真实的净利。', tag: '计算', iconColor: 'green', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['利润率', '成本结构'] }),
  createTool({ code: 'return-rate-education', name: '招生投入产出比（ROI）', description: '投入产出比（ROI）用招生带来的收入对比活动投入，帮助判断体验课、地推和老带新是否值得继续。', tag: '计算', iconColor: 'pink', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['ROI', '营销'] }),
  createTool({ code: 'class-rate-education', name: '消课率工具（教培版）', description: '帮你算清卖出去的课到底上了多少，消课率低=预收变成负债。', tag: '计算', iconColor: 'red', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['消课率', '预收款'] }),
  createTool({ code: 'gross-margin-beauty', name: '毛利率工具（美业版）', description: '帮你判断每个项目/套餐的真实利润。', tag: '计算', iconColor: 'pink', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['毛利率', '项目利润'] }),
  createTool({ code: 'break-even-beauty', name: '盈亏平衡点工具（美业版）', description: '帮你算出每月至少做多少业绩才不亏。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['盈亏平衡', '保本业绩'] }),
  createTool({ code: 'salary-cost-ratio-beauty', name: '员工成本占比工具（美业版）', description: '帮你看清手工费/提成是不是吃掉了太多营收。', tag: '计算', iconColor: 'orange', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['人效', '成本控制'] }),
  createTool({ code: 'labor-efficiency-beauty', name: '人效工具（美业版）', description: '帮你看清每个美容师是在"造钱"还是在"摸鱼"。', tag: '计算', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['人效', '排班'] }),
  createTool({ code: 'conversion-rate-beauty', name: '拓客转化率工具（美业版）', description: '帮你判断拓客活动到底有没有用。', tag: '计算', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['转化率', '拓客'] }),
  createTool({ code: 'project-profit-beauty', name: '项目利润工具（美业版）', description: '帮你算清每个项目的真实利润（含人工）。', tag: '计算', iconColor: 'green', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['项目利润', '定价'] }),
  createTool({ code: 'ltv-beauty', name: '客户生命周期价值工具（美业版）', description: '帮你算出一个客户从进店到流失总共贡献了多少。', tag: '计算', iconColor: 'pink', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['LTV', '客户价值'] }),
  createTool({ code: 'repurchase-rate-beauty', name: '复购率工具（美业版）', description: '帮你判断老客是不是真的认可你。', tag: '计算', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['复购率', '留存'] }),
  createTool({ code: 'payback-beauty', name: '投资回本周期工具（美业版）', description: '帮你算新店/新项目多久回本。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['回本', '投资'] }),
  createTool({ code: 'cashflow-beauty', name: '现金流预测工具（美业版）', description: '帮你预判资金链风险。', tag: '计算', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['现金流', '预测'] }),
  createTool({ code: 'profit-rate-beauty', name: '利润率工具（美业版）', description: '帮你算出美业门店的真实净利。', tag: '计算', iconColor: 'green', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['利润率', '成本结构'] }),
  createTool({ code: 'return-rate-beauty', name: '回报率工具（美业版）', description: '帮你判断拓客活动/仪器采购到底值不值。', tag: '计算', iconColor: 'pink', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['ROI', '营销'] }),
  createTool({ code: 'project-structure-beauty', name: '美业品项结构与利润工具', description: '品项分层分析（引流/留客/利润），诊断结构健康度。', tag: '核心', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['品项结构', '利润分析'] }),
  createTool({ code: 'labor-structure-beauty', name: '美业人工成本与人效分析', description: '美容师/顾问分组录入，计算人效、单床产出。', tag: '核心', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['人效', '成本控制'] }),
  createTool({ code: 'card-debt-beauty', name: '美业卡项负债与实收工具', description: '区分现金流与实收，预警沉淀资金风险。', tag: '核心', iconColor: 'rose', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['耗卡率', '负债预警'] }),
  createTool({ code: 'funnel-ltv-beauty', name: '美业拓客转化与 LTV 工具', description: '全漏斗分析，CAC vs LTV 比值判断。', tag: '核心', iconColor: 'indigo', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['转化漏斗', 'LTV'] }),
  ...
  createTool({ code: 'device-roi-beauty', name: '美容仪器投资回报工具', description: '热玛吉/光子等设备回本周期、保本客单量。', tag: '专项', iconColor: 'cyan', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['设备投资', '回本周期'] }),
  createTool({ code: 'member-card-design-beauty', name: '会员储值卡设计工具', description: '充送活动实际折扣率与毛利折损计算。', tag: '专项', iconColor: 'violet', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['beauty'], freePolicy: '5/day', sceneTags: ['储值卡', '促销设计'] }),

  // ====== 营销推广计算器 ======
  createTool({ code: 'channel-cac', name: '多渠道获客成本工具', description: '对比抖音/美团/地推/转介绍等渠道的获客成本，自动排序最优渠道。', tag: '营销', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'marketing', industries: ['restaurant', 'education', 'beauty', 'service'], freePolicy: '5/day', sceneTags: ['获客成本', '渠道对比'] }),
  createTool({ code: 'campaign-roi', name: '活动效果追踪工具', description: '投入/客流/成交/ROI 全链路追踪，自动生成活动复盘报告。', tag: '营销', iconColor: 'green', requiredLevel: MEMBER_LEVEL_FREE, category: 'marketing', industries: ['restaurant', 'education', 'beauty', 'service'], freePolicy: '5/day', sceneTags: ['活动复盘', 'ROI追踪'] }),
  createTool({ code: 'referral-roi', name: '转介绍效果工具', description: '计算转介绍率/K值/转介绍CAC vs 新客CAC，评估老带新活动效果。', tag: '营销', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_FREE, category: 'marketing', industries: ['restaurant', 'education', 'beauty', 'service'], freePolicy: '5/day', sceneTags: ['转介绍', '老带新'] }),
  createTool({ code: 'conversion-funnel', name: '营销转化漏斗工具', description: '线索→体验→成交→复购各环节转化率分析，找出最大流失环节。', tag: '营销', iconColor: 'orange', requiredLevel: MEMBER_LEVEL_FREE, category: 'marketing', industries: ['restaurant', 'education', 'beauty', 'service'], freePolicy: '5/day', sceneTags: ['转化漏斗', '流失分析'] }),
  createTool({ code: 'retention-rate', name: '客户留存率工具', description: '计算30/60/90天留存率，标记沉睡客户阈值，给出激活建议。', tag: '营销', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'marketing', industries: ['restaurant', 'education', 'beauty', 'service'], freePolicy: '5/day', sceneTags: ['留存率', '沉睡激活'] }),
  createTool({ code: 'marketing-budget', name: '营销预算分配工具', description: '输入总预算和营销目标，自动分配各渠道比例并预估效果。', tag: '营销', iconColor: 'indigo', requiredLevel: MEMBER_LEVEL_FREE, category: 'marketing', industries: ['restaurant', 'education', 'beauty', 'service'], freePolicy: '5/day', sceneTags: ['预算分配', '渠道规划'] }),
  createTool({ code: 'churn-rate', name: '客户流失率工具', description: '计算流失率和流失成本，分析流失原因，给出挽留优先级。', tag: '营销', iconColor: 'red', requiredLevel: MEMBER_LEVEL_FREE, category: 'marketing', industries: ['restaurant', 'education', 'beauty', 'service'], freePolicy: '5/day', sceneTags: ['流失率', '客户挽留'] }),
  createTool({ code: 'ltv-restaurant', name: '客户终身价值工具（餐饮版）', description: '客单价×月频次×留存月数=LTV，对比CAC判断投放是否值得。', tag: '营销', iconColor: 'cyan', requiredLevel: MEMBER_LEVEL_FREE, category: 'marketing', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['LTV', '客户价值'] }),
  createTool({ code: 'ltv-education', name: '学员长期价值（LTV）', description: '学员长期价值（LTV）按课时收入、在读时长和续费情况估算，用来对比新生招生成本（CAC）。', tag: '营销', iconColor: 'violet', requiredLevel: MEMBER_LEVEL_FREE, category: 'marketing', industries: ['education'], freePolicy: '5/day', sceneTags: ['LTV', '学员价值'] }),
  createTool({ code: 'promotion-profit', name: '促销活动利润工具', description: '折扣后毛利折损+保本增量分析，判断活动是否真正赚钱。', tag: '营销', iconColor: 'pink', requiredLevel: MEMBER_LEVEL_FREE, category: 'marketing', industries: ['restaurant', 'education', 'beauty', 'service'], freePolicy: '5/day', sceneTags: ['促销利润', '保本分析'] }),
]
...
export const standaloneCapabilities = [
  {
    code: 'diagnosis',
    name: '校区经营体检',
    description: '填写校区招生、体验课、报名和续费情况，先找本周主要问题。',
    tag: '诊断',
    status: 'launched',
    capabilityType: 'advanced',
    freePolicy: 'upgrade-required',
    sceneTags: ['校区经营', '主要问题', '优先动作'],
...
// 首阶段客户前台只聚焦儿童素质培训；其他行业保留在完整目录和历史路由中。
export const visibleIndustryEntries = industryEntries.filter(entry => entry.slug === 'education')
...
export const testimonials = [
  ...
  { quote: '校区经营体检帮我看清了招生短板，现在知道本周先抓哪一步。', author: '刘校长', city: '北京', industry: '儿童培训' },
...
export const homeFaqs = [
  ...
  { q: '行业场景和所有工具有什么区别？', a: '行业场景按业务类型帮你缩小入口范围，所有工具负责统一承接工具、计算器、输入模板、经营记录和输出报表。' },
  { q: '校区经营体检能解决什么？', a: '它帮助校长梳理招生、体验、报名和续费情况，重点确认问题卡在哪里、本周先做什么。' },
